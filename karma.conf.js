...
module.exports = function (config) {
  config.set({
    ...
    files: [
      ...
      // Datatable
      { pattern: 'node_modules/@swimlane/ngx-datatable/release/*.js', included: false, watched: true },

      // NgxUploader
      { pattern: 'node_modules/ngx-uploader/bundle/ngx-uploader.umd.js', included: false, watched: true },
